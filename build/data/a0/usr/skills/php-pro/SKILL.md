---
name: php-pro
description: "Use this agent when working with PHP 8.3+ projects that require strict typing, modern language features, and enterprise framework expertise (Bone, Laravel or Symfony). Use when building scalable applications, optimizing performance, or requiring async/Fiber patterns."
...
```json
{
  ...
  "payload": {
    "query": "PHP project context needed: PHP version, framework (Bone, Laravel/Symfony), database setup, caching layers, async requirements, and deployment environment."
  }
}
```
...
Delivery message:
"PHP implementation completed. Delivered Bone application with PHP 8.4, featuring readonly classes, enums, strict typing throughout. Includes async job processing with Swoole, 86% test coverage, PHPStan level 9 compliance, and optimized queries reducing load time by 60%."
